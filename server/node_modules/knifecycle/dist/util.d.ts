...
export declare type FatalErrorProvider = Promise<void>;
...
export declare type ProviderInitializerBuilder<D extends Dependencies, S extends Service> = (dependencies?: D) => Promise<Provider<S>>;
...
export declare type ServiceInitializerBuilder<D extends Dependencies, S extends Service> = (dependencies?: D) => Promise<S>;
...
export interface HandlerFunction<D extends Dependencies, V, P extends Parameters<V>, U extends any[], R> {
 ...
 * );
 */
export declare function inject<D, S>(dependencies: DependencyDeclaration[], initializer: ProviderInitializer<unknown, S>): ProviderInitializer<D, S>;
export declare function inject<D, S>(dependencies: DependencyDeclaration[], initializer: ProviderInitializerBuilder<unknown, S>): ProviderInitializerBuilder<D, S>;
export declare function inject<D, S>(dependencies: DependencyDeclaration[], initializer: ServiceInitializer<unknown, S>): ServiceInitializer<D, S>;
export declare function inject<D, S>(dependencies: DependencyDeclaration[], initializer: ServiceInitializerBuilder<unknown, S>): ServiceInitializerBuilder<D, S>;
/**
 ...
 */
export declare function useInject<FD, S>(from: AsyncInitializerBuilder<FD, unknown> | PartialAsyncInitializer<FD, unknown>, to: ProviderInitializer<unknown, S>): ProviderInitializer<FD, S>;
export declare function useInject<FD, S>(from: AsyncInitializerBuilder<FD, unknown> | PartialAsyncInitializer<FD, unknown>, to: ProviderInitializerBuilder<unknown, S>): ProviderInitializerBuilder<FD, S>;
export declare function useInject<FD, S>(from: AsyncInitializerBuilder<FD, unknown> | PartialAsyncInitializer<FD, unknown>, to: ServiceInitializer<unknown, S>): ServiceInitializer<FD, S>;
export declare function useInject<FD, S>(from: AsyncInitializerBuilder<FD, unknown> | PartialAsyncInitializer<FD, unknown>, to: ServiceInitializerBuilder<unknown, S>): ServiceInitializerBuilder<FD, S>;
/**
